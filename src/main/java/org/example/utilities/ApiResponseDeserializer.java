...
public class ApiResponseDeserializer {
    ...
    public static <T> T deserializeResponse(Response response, Class responseType) {
        ...
        if (jsonResponse instanceof Map) {
            ...
            responseObject = (T) objectMapper.convertValue(jsonResponse, responseType);
        } else {
    ...
    private static  void setFieldIfExists(Class responseType, Object responseObject, String fieldName, Object value) {
        try {
    ...
    private static Map convertHeadersToMap(Headers headers) {
